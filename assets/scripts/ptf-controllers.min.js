...
(function ($) {
    ...
    var PTFJS = {
        initMenu: function (menuSelector, toggleSelector) {
            var menu = $(menuSelector),
                navigation = menu.find('ul.sf-menu'),
                menuToggle = $(toggleSelector),
            ...
            menuToggle.on('click', function (e) {
                e.preventDefault();
                if (!menuIsOpen) {
                    PTFJS.openMenu(menu, siteOverlay);
                } else {
                    PTFJS.closeMenu(menu, siteOverlay);
                }
            });
        ...
        openMenu: function (menu, siteOverlay) {
            menuIsOpen = true;
            menu.addClass('is-open');
            siteOverlay.fadeIn();
        },
        closeMenu: function (menu, siteOverlay) {
            menuIsOpen = false;
    ...
    PTFJS.initMenu('.ptf-offcanvas-menu-all', '.js-offcanvas-menu-toggle-catall');
    PTFJS.initMenu('.ptf-offcanvas-menu', '.js-offcanvas-menu-toggle');
        ...
        init: function () {
            ...
            $('a[href^="#"]').on('click', function (e) {
                ...
                if (targetSection.length) {
                    // Find the index of the section to scroll to it
                    var targetIndex = fullpageSlider.find('.section').index(targetSection) + 1;
                    $.fn.pagepiling.moveTo(targetIndex);
                }

                // Close the off-canvas menu
                $('.ptf-offcanvas-menu').removeClass('is-open');
                $('.ptf-site-overlay').css('display', 'none');
            });
